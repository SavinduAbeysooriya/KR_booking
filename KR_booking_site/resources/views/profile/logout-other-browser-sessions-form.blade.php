...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        <div class="d-flex align-items-center mt-4">
            ...
            <div class="ms-3 text-success" wire:loading.remove wire:target="confirmLogout">
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                ...
                <div class="mt-3" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <input type="password" class="form-control w-75" autocomplete="current-password" placeholder="{{ __('Password') }}" x-ref="password" wire:model="password" wire:keydown.enter="logoutOtherBrowserSessions" />
                    <x-input-error for="password" class="mt-2" />
                </div>
            </x-slot>
