                ...
                <div class="mt-5 mt-xl-0 mt-xxl-5 mb-5 mb-xxl-0">
                  <div class="row flex-between-end gy-3 gx-2">
                    ...
                    <div class="col-12 col-sm-auto ms-auto order-1 order-sm-0 order-md-1 order-lg-0 order-xxl-1">
                      <select class="form-select form-select-sm pe-9 w-auto" data-activities-options="data-activities-options">
                  ...
                  <div class="d-flex align-items-center">
                    <div class="search-box ms-xl-6 w-auto">
                      <form class="position-relative">
                        <input class="form-control search-input search" type="search" placeholder="Search by Flight no." aria-label="Search" />
                        <span class="fas fa-search search-box-icon"></span>

                      </form>
                    </div>
                    <button class="btn btn-phoenix-secondary px-3 ms-2 me-3"><span class="fa-solid fa-filter text-body-secondary" data-fa-transform="down-2"></span></button>
                  </div>
                  <div class="d-flex align-items-center">
                    <div class="pagination d-none"></div>
                    <p class="mb-0 d-none d-md-block me-3 fw-semibold text-body text-nowrap" data-list-info="data-list-info"></p>
                    <div class="d-none d-sm-block"><a class="fw-semibold text-nowrap" href="#!" data-list-view="*">View all<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a><a class="fw-semibold d-none text-nowrap" href="#!" data-list-view="less">View Less</a></div>
                    <button class="btn btn-phoenix-primary px-3 me-1 ms-sm-4" type="button" title="Previous" data-list-pagination="prev"><span class="fas fa-chevron-left" data-fa-transform="down-1"></span></button>
                  ...
                  <tr>
                    <th class="white-space-nowrap px-0 py-1">
                      <div class="form-check mb-0 fs-8">
                        <input class="form-check-input" id="checkbox-bulk-flights-select" type="checkbox" data-bulk-select='{"body":"table-flights-body"}' />
                      </div>
                    </th>
                  ...
                  <tr>
                    ...
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                        <div class="progress-bar overflow-visible position-relative bg-info-light rounded" style="width: 25%"><span class="fa-solid fa-plane text-info position-absolute end-0"></span>
                        </div>
                      </div>
                    ...
                    <td class="align-middle text-end">
                      <div class="btn-reveal-trigger">
                        <button class="btn btn-sm ms-auto dropdown-toggle dropdown-caret-none transition-none d-flex btn-reveal" type="button" data-bs-toggle="dropdown" data-boundary="window" aria-haspopup="true" aria-expanded="false" data-bs-reference="parent"><span class="fas fa-ellipsis-h"></span></button>
                  ...
                  <tr>
                    ...
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                        <div class="progress-bar overflow-visible position-relative bg-info-light rounded" style="width: 60%"><span class="fa-solid fa-plane text-info position-absolute end-0"></span>
                        </div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
                  ...
                  <tr>
                    ...
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                        <div class="progress-bar overflow-visible position-relative bg-info-light rounded" style="width: 0%">
                        </div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
                  ...
                  <tr>
                    ...
                    <td class="align-middle destination pe-5 pe-xxl-7">
                      <div class="progress overflow-visible" role="progressbar" aria-label="flight-progress-bar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="height: 2px">
                        <div class="progress-bar overflow-visible position-relative bg-info-light rounded" style="width: 75%"><span class="fa-solid fa-plane text-info position-absolute end-0"></span>
                        </div>
                      </div>
                      <div class="d-flex justify-content-between mt-2">
            ...
            <div class="mapbox-container">
              <div class="position-relative">
                ...
                <div class="mapbox-control-btn flight-map-control-btn">
                  <button class="zoomIn d-none d-md-block"><span class="fa-solid fa-plus"></span></button>
